...
HD_PWD='C:/Vivado/ENGG 3050/Custom_Matrix_Multiplier/Pure_VHDL/Pure_VHDL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log matrix_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source matrix_top.tcl -notrace
