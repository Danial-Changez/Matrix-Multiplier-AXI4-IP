...
HD_PWD='C:/Vivado/ENGG 3050/Custom_Matrix_Multiplier/Pure_VHDL/Pure_VHDL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matrix_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matrix_top.tcl
