...
## Buttons
set_property -dict { PACKAGE_PIN N17 IOSTANDARD LVCMOS33 } [get_ports { rst }];        # BTN_CENTER
set_property -dict { PACKAGE_PIN M17 IOSTANDARD LVCMOS33 } [get_ports { cycle_btn }];  # BTN_RIGHT
