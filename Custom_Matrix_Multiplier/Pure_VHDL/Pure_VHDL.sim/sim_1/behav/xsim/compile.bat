...
REM
REM Generated by Vivado on Thu Nov 20 17:35:15 -0500 2025
...
echo "xvhdl --incr --relax -prj matrix_mult_tb_vhdl.prj"
call xvhdl  --incr --relax -prj matrix_mult_tb_vhdl.prj -log xvhdl.log
