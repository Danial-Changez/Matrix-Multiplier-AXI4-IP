...
//               3050/Custom_Matrix_Multiplier/Block_Design/Block_Design.gen/sources_1/bd/zynq_design_1/ip/zynq_design_1_matrix_multiplier_0_7/zynq_design_1_matrix_multiplier_0_7_stub.v}
...
(* CHECK_LICENSE_TYPE = "zynq_design_1_matrix_multiplier_0_7,matrix_multiplier,{}" *) (* core_generation_info = "zynq_design_1_matrix_multiplier_0_7,matrix_multiplier,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=matrix_multiplier,x_ipVersion=1.0,x_ipCoreRevision=7,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED,C_S00_AXI_DATA_WIDTH=32,C_S00_AXI_ADDR_WIDTH=6}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "matrix_multiplier,Vivado 2025.1" *) 
module zynq_design_1_matrix_multiplier_0_7(s00_axi_aclk, s00_axi_aresetn, 
