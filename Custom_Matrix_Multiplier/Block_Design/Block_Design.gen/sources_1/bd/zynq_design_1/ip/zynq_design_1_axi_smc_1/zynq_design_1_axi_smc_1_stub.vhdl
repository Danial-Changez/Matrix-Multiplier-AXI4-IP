...
-- Date        : Thu Nov 20 00:55:14 2025
-- Host        : Danials-Laptop running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top zynq_design_1_axi_smc_1 -prefix
--               zynq_design_1_axi_smc_1_ zynq_design_1_axi_smc_1_stub.vhdl
-- Design      : zynq_design_1_axi_smc_1
...
entity zynq_design_1_axi_smc_1 is
  Port ( 
    aclk : in STD_LOGIC;
  ...
  attribute CHECK_LICENSE_TYPE of zynq_design_1_axi_smc_1 : entity is "zynq_design_1_axi_smc_1,bd_a4c7,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of zynq_design_1_axi_smc_1 : entity is "zynq_design_1_axi_smc_1,bd_a4c7,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=27,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of zynq_design_1_axi_smc_1 : entity is "yes";
end zynq_design_1_axi_smc_1;

architecture stub of zynq_design_1_axi_smc_1 is
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN zynq_design_1_processing_system7_0_1_FCLK_CLK0, ASSOCIATED_BUSIF M00_AXI:S00_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN s_sc_aclken";
  ...
  attribute X_CORE_INFO of stub : architecture is "bd_a4c7,Vivado 2025.1";
begin
end;
