...
// Command     : write_verilog -force -mode synth_stub -rename_top zynq_design_1_axi_smc_1 -prefix
//               zynq_design_1_axi_smc_1_ zynq_design_1_axi_smc_1_stub.v
...
(* CHECK_LICENSE_TYPE = "zynq_design_1_axi_smc_1,bd_a4c7,{}" *) (* CORE_GENERATION_INFO = "zynq_design_1_axi_smc_1,bd_a4c7,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=27,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_a4c7,Vivado 2025.1" *) 
module zynq_design_1_axi_smc_1(aclk, aresetn, S00_AXI_awid, S00_AXI_awaddr, 
