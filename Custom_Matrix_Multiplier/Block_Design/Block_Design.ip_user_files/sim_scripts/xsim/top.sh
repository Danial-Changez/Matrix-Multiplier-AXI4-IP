...
#
# Script generated by Vivado on Thu Nov 20 17:49:03 -0500 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xilinx_vip -L xpm -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L processing_system7_vip_v1_0_23 -L xlconstant_v1_1_10 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_35 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot  xil_defaultlib. xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  -key {Behavioral:sim_1:Functional:} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_a4c7.protoinst" -protoinst "protoinst_files/zynq_design_1.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_21 processing_system7_vip_v1_0_23 xlconstant_v1_1_10 proc_sys_reset_v5_0_17 smartconnect_v1_0 axi_register_slice_v2_1_35)
