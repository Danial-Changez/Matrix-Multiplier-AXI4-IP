...
HD_PWD='C:/Vivado/ENGG 3050/Custom_Matrix_Multiplier/Block_Design/Block_Design.runs/zynq_design_1_rst_ps7_0_100M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_design_1_rst_ps7_0_100M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_design_1_rst_ps7_0_100M_1.tcl
